...
Most cases that can reasonably be covered by simple query building are already implemented in the provided convenience methods.
These are all fixed parameter methods and they cover cases that are simple but repetitive to write.
